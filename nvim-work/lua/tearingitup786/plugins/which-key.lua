return {
	...
	config = function()
		...
		wk.add({
			...
			{ "<leader>oca", desc = "Ask opencode" },
			{ "<leader>oce", desc = "Execute opencode action" },
			{ "<leader>oct", desc = "Toggle opencode" },
			{ "<leader>ocr", desc = "Add range to opencode" },
			{ "<leader>ocl", desc = "Add line to opencode" },
			{ "<leader>ocu", desc = "Scroll opencode up" },
			{ "<leader>ocd", desc = "Scroll opencode down" },
